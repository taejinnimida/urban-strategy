...
ck('R37 station complex uses hill FACT not missing SHP string', '40m+10° 동시충족' in HTML and "구릉지','구릉지 제외·연접 여부','공개 SHP 미확보'" not in HTML)
ck('R37 longterm hill FACT remains connected after R39 rule link', "hill:{status:hillStatus,value:hillValue" in HTML and "sourceId:'LONGTERM_OP',locator:'2-1-3·2-1-5'" in HTML)
